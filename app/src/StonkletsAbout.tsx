...
const sections = [
      ...
      { title: "Your Turn to Be Early", body: "The underlying assets may already be worth billions or trillions. The Stonklet market starts at zero. A new attention economy, new liquidity and a new opportunity to participate from the beginning.", callout: "Can a meme market outperform the real market?" },
];
...
export default function StonkletsAbout() {
  return <div className="pt-6">
    ...
    <div className="overflow-hidden rounded-xl border border-[#00FF00]/25 bg-black/70">
      ...
      <p className="px-4 pb-5 pt-2 text-center text-xl font-black text-[#00FF00]">Can a meme market outperform the real market?</p>
    </div>
