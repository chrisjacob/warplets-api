-- 10X Warplets: one-time post-reset NFT sales backfill (v1)
--
-- Run this query once when bootstrapping or repairing D1. Daily automation
-- must use warplets_sales_incremental_v1.sql instead.
--
-- The coverage row is always emitted, including when no trade rows exist.
